...
const postpelicula = async (req, res) => {
        ...
        const { pelicula_nombre,
            tipo_pelicula } = req.body;

        const params = [pelicula_nombre,
            tipo_pelicula,
            2];
        ...
        const sql = ` insert into tbl_pelicula 
                    ...
                    tipo_pelicula)
                    values 
                    ($1, $2, 2) returning pelicula_nombre 'creado con exito' mensaje `;
...
const putpelicula = async (req, res) => {
    ...
    try {
        ...
        const { pelicula_nombre} = req.body;
        const tipo_pelicula = req.params.pelicula_nombre;
        ...
        const sql = `update tbl_pelicula 
                    set pelicula_nombre = $1, 
                        tipo_pelicula = $2
                    where pelicula_nombre = $3 returning pelicula_nombre , 'actualizado con exito' mensaje `;
